...
object McpToolRegistry {
    ...
    fun getAllTools(): List<McpToolDefinition> = listOf(
        ...
        McpToolDefinition(
            ...
            description = "Get clipboard via ADB. Requires ADB bridge for Android 10+ background access restriction.",
            inputSchema = buildJsonObject { put("type", "object"); putJsonObject("properties") {} }
        ),
        ...
        McpToolDefinition(
            ...
            description = "Close app. Default: graceful (HOME). Force-stop requires ADB bridge.",
            inputSchema = buildJsonObject {
                put("type", "object")
                putJsonObject("properties") {
                    putJsonObject("package_name") { put("type", "string"); put("description", "Package name") }
                    putJsonObject("force") { put("type", "boolean"); put("description", "Force-stop via ADB (requires ADB bridge)") }
                }
                putJsonArray("required") { add(JsonPrimitive("package_name")) }
            }
        ),
        ...
        McpToolDefinition(
            ...
            description = "Install an APK on the device. Requires ADB bridge.",
            inputSchema = buildJsonObject {
                put("type", "object")
                putJsonObject("properties") {
                    putJsonObject("apk_path") { put("type", "string"); put("description", "Absolute path to the APK file on the host machine") }
                    putJsonObject("replace") { put("type", "boolean"); put("description", "Replace existing installation if present (default true)") }
                }
                putJsonArray("required") { add(JsonPrimitive("apk_path")) }
            }
        ),
        McpToolDefinition(
        ...
        McpToolDefinition(
            ...
            inputSchema = buildJsonObject {
                put("type", "object")
                putJsonObject("properties") {
                    putJsonObject("package_name") { put("type", "string"); put("description", "Package name (e.g. com.example.app)") }
                    putJsonObject("keep_data") { put("type", "boolean"); put("description", "Keep app data and cache after removal (default false)") }
                }
                putJsonArray("required") { add(JsonPrimitive("package_name")) }
            }
        ),
        ...
        McpToolDefinition(
            ...
            inputSchema = buildJsonObject {
                ...
                putJsonObject("properties") {
                    putJsonObject("package_name") { put("type", "string"); put("description", "Package name (e.g. com.example.app)") }
                    putJsonObject("permission") { put("type", "string"); put("description", "Android permission string (e.g. android.permission.CAMERA)") }
                }
                putJsonArray("required") { add(JsonPrimitive("package_name")); add(JsonPrimitive("permission")) }
            }
        ),
        McpToolDefinition(
            name = "android_revoke_permission",
            description = "Revoke a runtime permission from an app. Only works for runtime (dangerous) permissions.",
            inputSchema = buildJsonObject {
                put("type", "object")
                putJsonObject("properties") {
                    putJsonObject("package_name") { put("type", "string"); put("description", "Package name (e.g. com.example.app)") }
        ...
        McpToolDefinition(
            ...
            description = "Capture logcat for debugging. Requires ADB bridge.",
            inputSchema = buildJsonObject {
                put("type", "object")
                putJsonObject("properties") {
                    putJsonObject("package") { put("type", "string"); put("description", "Package name filter") }
                    putJsonObject("level") { put("type", "string"); put("description", "Log level (V, D, I, W, E, F; default W)") }
                    putJsonObject("lines") { put("type", "integer"); put("description", "Lines to return (default 100)") }
                    putJsonObject("crash_only") { put("type", "boolean"); put("description", "Only crash reports") }
                }
            }
        )
    )
