...
class McpToolHandler(
    ...
    suspend fun handleToolCall(toolName: String, arguments: JsonObject?): McpToolCallResult {
        ...
        return try {
            when (toolName) {
                ...
                "android_get_clipboard" -> adbBridgeRequired(toolName)
                ...
                "android_install_app" -> adbBridgeRequired(toolName)
                ...
                "android_capture_logcat" -> adbBridgeRequired(toolName)
    ...
    private fun handleCloseApp(args: JsonObject): McpToolCallResult {
        ...
        return textResult("{\"success\":true,\"note\":\"Moved to background via HOME. Force-stop requires ADB bridge.\"}")
    }
    ...
    private fun adbBridgeRequired(toolName: String): McpToolCallResult = errorResult(
        "Tool '$toolName' requires the optional ADB bridge. " +
        "See: https://github.com/neural-bridge/adb-bridge for setup instructions."
    )
}
